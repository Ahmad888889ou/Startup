    ...
    return (
        <div className="container mb-5">
            <div className="row">
                ...
                <div className="col-12   col-md-6 col-lg-6 ">
                    <div className='mt-3'>
                        <img className='img-fluid' src="https://images.unsplash.com/photo-1552581234-26160f608093?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8bWVldGluZ3xlbnwwfHwwfHw%3D&auto=format&fit=crop&w=600&q=60" alt="image" width='550px' height='400px' />
                    </div>
                </div>
            </div>
        </div>
